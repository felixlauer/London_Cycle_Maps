 ...
 * saving posts a schema-v2 profile to POST /profiles via apiFetch, which
 * attaches a fresh Supabase JWT per request (or the test-mode header).
 */
export default function PresetWizard({ themeMode, testMode = false, onClose, onCreated }) {
