...
export function formatDepartHm(hour, minute) {
 ...
 * Incomplete 1–3 digit strings that are not a valid H:MM are null except
 * 1–2 digits (hour only) used on blur.
 */
export function parseDepartTime(raw, { hourOnlyOnShort = true } = {}) {
...
export function maskTimeDigits(raw) {
